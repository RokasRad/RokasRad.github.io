#!/bin/bash
# This script creates Client VM and calls asnible to play yaml playbook

CUSER=
CPASS=
CENDPOINT=https://grid5.mif.vu.lt/cloud3/RPC2

CVMREZ=$(onetemplate instantiate "debian8-for-virtualization" --name "client-vm"  --user $CUSER --password $CPASS  --endpoint $CENDPOINT)
